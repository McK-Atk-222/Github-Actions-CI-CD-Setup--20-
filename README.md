# Github Actions CI CD Setup (20)

## Description
Project to create a CI/CD pipeline using GitHub Actions to run the component tests via Cypress when a Pull Request is made to the develop branch, and have the application deploy when code is merged from develop to the main branch.
